...
import santamartaVideo1 from "@/assets/santamarta1.mp4";
import santamartaVideo2 from "@/assets/santamarta2.mp4";

const SantaMarta = ({ isMenuShown }) => {
  ...
  const travels = [
    {
      id: 1,
      src: santamartaVideo1,
      code: "",
      ref: ref1,
    },
    {
      id: 2,
      src: santamartaVideo2,
      code: "",
      ref: ref2,
    },
  ];
